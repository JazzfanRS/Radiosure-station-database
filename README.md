...
I am new to github and have only used the RadioSure application, so my apologies if this is cumbersome to use. As interested parties we are looking at the best way to keep the database active and accessible to all volunteers to modify or update, regardless of what the end application is.
